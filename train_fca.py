...
def train(configs):
    ...
    if 'ENTROPY' in configs['algorithm']:
    ...
    elif 'MINE' in configs['algorithm']: # MINE, BC
        embedding_dim = configs['layer_sizes'][1]
        policy = TanhGaussianPolicyWithEmbedding(
            obs_dim=obs_dim * stacksize,
            action_dim=action_dim,
...
if __name__ == "__main__":
    ...
    methodlist = ['MINE','ENTROPY-IB']      # BC-IB
    envlist = ['HalfCheetah', 'Ant']         # ['HalfCheetah', 'Ant',  'Ant', 'Hopper']  #'HalfCheetah', 'Walker2d', 'Ant']
    stacksizelist = [2, 4]                   # MDP=0
    seedlist = [0, 1, 2, 3, 4]               # ,3,4]
    ib_coef_list = [0]
    reg_coef_list = [10, 100]          # [1e-4]
    mine_steps_list = [5]
    ...
    # missing_configs =[
    #     {'env': 'HalfCheetah', 'stacksize':2, 'method': 'MINE', 'seed': 1, 'reg_coef': 0.01},
    #     {'env': 'HalfCheetah', 'stacksize':4, 'method': 'MINE', 'seed': 1, 'reg_coef': 0.01},
    #     {'env': 'HalfCheetah', 'stacksize':4, 'method': 'MINE', 'seed': 3, 'reg_coef': 0.01},
    #     {'env': 'Ant', 'stacksize':2, 'method': 'MINE', 'seed': 2, 'reg_coef': 0.01},
    #     {'env': 'Ant', 'stacksize':2, 'method': 'MINE', 'seed': 3, 'reg_coef': 0.01},
    #     {'env': 'Ant', 'stacksize':2, 'method': 'MINE', 'seed': 4, 'reg_coef': 0.01},
    #     {'env': 'Ant', 'stacksize':4, 'method': 'MINE', 'seed': 0, 'reg_coef': 0.01},
    #     {'env': 'Ant', 'stacksize':4, 'method': 'MINE', 'seed': 1, 'reg_coef': 0.01},
    #     {'env': 'Ant', 'stacksize':4, 'method': 'MINE', 'seed': 3, 'reg_coef': 0.01},
    #     {'env': 'Ant', 'stacksize':4, 'method': 'ENTROPY-IB', 'seed': 2, 'reg_coef': 1.},        
    #     {'env': 'HalfCheetah', 'stacksize':2, 'method': 'MINE', 'seed': 3, 'reg_coef': 1.},
    #     {'env': 'HalfCheetah', 'stacksize':2, 'method': 'MINE', 'seed': 0, 'reg_coef': 0.1},
    #     {'env': 'HalfCheetah', 'stacksize':2, 'method': 'ENTROPY-IB', 'seed': 3, 'reg_coef': 1.},
    #     {'env': 'HalfCheetah', 'stacksize':4, 'method': 'MINE', 'seed': 0, 'reg_coef': 0.1},
    #     {'env': 'HalfCheetah', 'stacksize':4, 'method': 'MINE', 'seed': 4, 'reg_coef': 0.1},
    #     {'env': 'HalfCheetah', 'stacksize':4, 'method': 'MINE', 'seed': 1, 'reg_coef': 1.},
    #     {'env': 'Ant', 'stacksize':2, 'method': 'MINE', 'seed': 1, 'reg_coef': 0.1},
    #     {'env': 'Ant', 'stacksize':2, 'method': 'MINE', 'seed': 2, 'reg_coef': 0.1},
    #     {'env': 'Ant', 'stacksize':2, 'method': 'MINE', 'seed': 3, 'reg_coef': 0.1},
    #     {'env': 'Ant', 'stacksize':2, 'method': 'MINE', 'seed': 1, 'reg_coef': 1.},
    #     {'env': 'Ant', 'stacksize':2, 'method': 'MINE', 'seed': 4, 'reg_coef': 1.},
    #     {'env': 'Ant', 'stacksize':2, 'method': 'ENTROPY-IB', 'seed': 0, 'reg_coef': 0.01},
    #     {'env': 'Ant', 'stacksize':2, 'method': 'ENTROPY-IB', 'seed': 0, 'reg_coef': 1.},
    #     {'env': 'Ant', 'stacksize':4, 'method': 'MINE', 'seed': 0, 'reg_coef': 1.},
    #     {'env': 'Ant', 'stacksize':4, 'method': 'MINE', 'seed': 1, 'reg_coef': 1.},
    #     {'env': 'Ant', 'stacksize':4, 'method': 'MINE', 'seed': 2, 'reg_coef': 1.},
    #     {'env': 'Ant', 'stacksize':4, 'method': 'MINE', 'seed': 0, 'reg_coef': 0.1},
    #     {'env': 'Ant', 'stacksize':4, 'method': 'MINE', 'seed': 1, 'reg_coef': 0.1},
    #     {'env': 'Ant', 'stacksize':4, 'method': 'MINE', 'seed': 2, 'reg_coef': 0.1},
    #     {'env': 'Ant', 'stacksize':4, 'method': 'ENTROPY-IB', 'seed': 4, 'reg_coef': 1.},
    #     {'env': 'Ant', 'stacksize':4, 'method': 'ENTROPY-IB', 'seed': 4, 'reg_coef': 0.01},          #31       
    # ]

    method, envtype, stacksize, seed, ib_coef, reg_coef, mine_steps, batch_size, dataset_size = \
        list(product(methodlist, envlist, stacksizelist, seedlist, ib_coef_list, 
                     reg_coef_list, mine_steps_list, batch_size_list, dataset_size_list))[pid] 
    ...
    # ib_coef = ib_coef_list[0]
    # mine_steps = mine_steps_list[0]
    ...
    algorithm = f'{method}W{stacksize}_{identifying_str}_B{batch_size}_AH{action_history_len}'
